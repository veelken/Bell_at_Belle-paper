...
\begin{tikzpicture}
  \begin{feynman}
    ...
    \diagram* {
      (b) -- [fermion, reversed momentum'={[arrow shorten=0.3]\scriptsize\(p_+\)}] (a),
      (c) -- [fermion, momentum'={[arrow shorten=0.3]\scriptsize\(p_-\)}] (b),
      (b) -- [photon, edge label=\(\gamma\)] (d),
      (e) -- [fermion, reversed momentum'={[arrow shorten=0.3]\scriptsize\(k_+\)}] (d),
      (d) -- [fermion, momentum'={[arrow shorten=0.3]\scriptsize\(k_-\)}] (f)
    };
  \end{feynman}
\end{tikzpicture}
